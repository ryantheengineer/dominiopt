function [gain_priority,gain_cutoffs,play_priority,trash_priority] = random_strategy(CARDS)
    ...
    gain_cutoffs(3,:) = randi([2 12],1,numcards); % Random integers between some limits (might need to be different limits depending on the card), but values can repeat
